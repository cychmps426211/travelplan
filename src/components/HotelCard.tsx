    ...
    return (
        <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-xl shadow-sm border border-slate-200 dark:border-gray-800 overflow-hidden relative group">
            ...
            <div className="p-5">
                    ...
                    <div>
                        ...
                        {hotel.address && (
                            <a
                                ...
                                className="flex items-center gap-1.5 text-blue-600 dark:text-blue-400 hover:text-blue-800 text-sm mt-1 hover:underline w-fit"
                            >
                ...
                {hotel.address && (
                    <div className="mt-5 h-48 w-full rounded-xl overflow-hidden border border-gray-200 dark:border-gray-800">
                        <iframe
                            ...
                            className="dark:invert dark:hue-rotate-180 dark:opacity-90"
                        ></iframe>
                    </div>
                )}
            </div>
