...
import { Plane, Clock, Edit2, CheckCircle2, Trash2 } from 'lucide-react';
...
export default function FlightCard({ flight, type, onEdit, onDelete }: FlightCardProps) {
    ...
    return (
        <>
            <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-xl border border-gray-200 dark:border-gray-800 p-5 hover:shadow-md transition-shadow relative group">
                <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                        <div className={`p-2 rounded-lg ${type === 'outbound' ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400'}`}>
                    ...
                    return (
                        <div className="mt-4">
                            <div className="flex justify-between items-end mb-2">
                                ...
                                <span className="text-xs font-mono text-slate-500 dark:text-gray-400 bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-full">
                            ...
                            <div className="relative h-3 bg-slate-100 dark:bg-slate-800 rounded-full overflow-visible">
                                ...
                                >
                                    <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-1 rounded-full shadow-md border border-blue-100">
                                        <Plane className="w-3 h-3 text-blue-600 dark:text-blue-400 rotate-90" fill="currentColor" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {hasDeparted && (
                    <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-3 flex items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400 font-medium">
            ...
            <ConfirmDialog
                ...
                title="刪除航班"
                message={`確定要刪除此${type === 'outbound' ? '去程' : '回程'}航班嗎？`}
                onConfirm={() => {
